...
<head>
    ...
    <title>Masuk | {{ config('app.name') }} DPR RI</title>
    ...
    <div class="row g-0 row-full">
        <div class="col-lg-5 col-xl-4 login-column">
            <div class="login-box">
                ...
                <div class="login-badge">Portal Peserta</div>
                <h1 class="card-title">Masuk Akun</h1>
                <p class="card-text">Silakan gunakan email dan password terdaftar Anda untuk mengakses portal magang.</p>

                <a href="{{ route('Halaman awal') }}" class="btn-back">
                    Kembali ke Beranda
                </a>

                <form method="POST" action="{{ route('user.login') }}" style="margin-top: 0;" id="loginForm">
                    @csrf
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('password.request') }}" class="small" style="color: var(--gold-solid); font-weight: 600; text-decoration: none;">
                            Lupa password?
                        </a>
                    </div>
                    ...
                    <p class="text-center mt-4 text-muted small">
                        Belum punya akun? <a href="{{ route('Halaman awal') }}#lowongan-section" style="color: var(--gold-solid); font-weight: 700; text-decoration: none;">Daftar Sekarang</a>
                    </p>
                    <p class="text-center mt-2 text-muted small">
                        <a href="{{ route('admin.login.form') }}" style="color: var(--gold-solid); font-weight: 700; text-decoration: none;">Portal Pegawai</a>
                    </p>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-7 col-xl-8 image-column d-none d-lg-block">
            ...
            <div class="overlay-content">
                ...
                <h2>Membangun Kompetensi <br>Untuk Negeri.</h2>
                <p class="lead opacity-75">Jadilah bagian dari perjalanan legislatif Indonesia melalui program magang yang berintegritas dan profesional.</p>
            </div>
        </div>
    </div>
