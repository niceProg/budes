...
<head>
    ...
    <script>
        // Terapkan mode yang tersimpan (dark / light) juga di halaman login
        (function() {
            try {
...
<body>
    ...
    <div class="row g-0 row-full">
        <div class="col-lg-5 col-xl-4 login-column">
            <div class="login-box">
                ...
                <p class="card-text">Silakan gunakan kredensial terdaftar Anda untuk mengakses portal magang.</p>
    ...
    <script>
        ...
        // Tampilkan loading saat submit login
