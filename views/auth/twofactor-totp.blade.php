...
<body>
    ...
    <a href="{{ route('user.twofactor.method') }}" class="tf-back"><span>&larr;</span><span>Kembali</span></a>

    <div class="tf-container">
        <div class="tf-title">Selamat datang di {{ config('app.name') }}</div>
        <div class="tf-subtitle">Masukkan kode dari aplikasi authenticator untuk menyelesaikan login.</div>
        ...
        <div class="tf-panel">
            ...
            <form method="POST" action="{{ route('user.twofactor.totp.verify') }}" id="twofactor-totp-form" data-no-page-loader>
                @csrf
