...
@section('title', 'Data Absensi | Atasan - SMART Setjen DPR RI')
@section('content')
<!-- Import Fonts & Icons -->
...
<style>
    ...
    .badge { padding: 0.4rem 0.8rem; font-size: 0.75rem; font-weight: 600; border-radius: 8px; }
        ...
        <div class="page-title-area">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item active">Atasan Absensi</li>
                </ol>
            </nav>
...
<div class="modern-card">
    ...
    @endif
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('absensi.atasan.export', array_merge(request()->query(), ['scope' => 'all', 'format' => 'pdf'])) }}">
                                    PDF (Semua)
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('absensi.atasan.export', array_merge(request()->query(), ['scope' => 'all', 'format' => 'xlsx'])) }}">
                                    Excel (Semua)
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('absensi.atasan.export', array_merge(request()->query(), ['scope' => 'page', 'page' => request('page', 1), 'format' => 'pdf'])) }}">
                                    PDF (Halaman ini)
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('absensi.atasan.export', array_merge(request()->query(), ['scope' => 'page', 'page' => request('page', 1), 'format' => 'xlsx'])) }}">
                                    Excel (Halaman ini)
                                </a>
                            </li>
                        </ul>
            ...
            <div class="filter-section">
                <form method="GET" action="{{ route('absensi.atasan.index') }}" id="filterForm">
            ...
            <thead>
                <tr>
                    ...
                    <th>Nama Peserta</th>
                    <th>Jenis Magang</th>
                    <th class="text-center">Jenis Kehadiran</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        @else
                            <span class="text-muted small">
                                <i class="ri-time-line text-warning"></i> Belum Diverifikasi
                            </span>
                        @endif
                    </td>
