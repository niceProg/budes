...
@section('title', 'Biodata Peserta Banned | Admin - SMART Setjen DPR RI')
@section('content')
        ...
        <div class="page-title-area">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item active">Peserta Terblokir</li>
                </ol>
            </nav>
            <h1 class="page-title">Peserta Terblokir</h1>
        </div>
        ...
        <div class="modern-card">
            <div class="card-toolbar flex-wrap gap-4">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="m-0 fw-800 text-dark">Daftar Peserta Terblokir</h5>
                </div>
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('biodata.banned.export', array_merge(request()->query(), ['scope' => 'all', 'format' => 'pdf'])) }}">
                                    PDF (Semua)
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('biodata.banned.export', array_merge(request()->query(), ['scope' => 'all', 'format' => 'xlsx'])) }}">
                                    Excel (Semua)
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('biodata.banned.export', array_merge(request()->query(), ['scope' => 'page', 'page' => request('page', 1), 'format' => 'pdf'])) }}">
                                    PDF (Halaman ini)
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('biodata.banned.export', array_merge(request()->query(), ['scope' => 'page', 'page' => request('page', 1), 'format' => 'xlsx'])) }}">
                                    Excel (Halaman ini)
                                </a>
                            </li>
                        </ul>
                    ...
                    <tbody>
                                    ...
                                    <div>
                                        ...
                                        <div class="d-lg-none mt-1">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <span class="small fw-600 text-muted">{{ ucwords(strtolower(Str::limit($val->lamaran->instansi ?? 'Tidak Terdata', 25))) }}</span>
                                            </div>
                                        </div>
                            ...
                            <td class="d-none d-md-table-cell">
                                ...
                                <td class="d-none d-lg-table-cell">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span>{{ ucwords($val->lamaran->instansi ?? 'Tidak Terdata') }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('biodata.show', $val->id) }}?from=banned" class="btn-action" title="Detail Peserta">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                ...
                                <p class="text-muted mt-3 fw-700">Tidak ada peserta yang terblokir saat ini.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
