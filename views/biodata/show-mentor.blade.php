...
@section('title', 'Detail Biodata Peserta | Mentor - SMART Setjen DPR RI')
@section('content')
    <style>
        :root {
            --primary-dark: #0f172a;
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        @php
            $mentorBackUrl = request('from') === 'lulus' ? route('mentor.biodata.lulus.index') : route('mentor.biodata.index');
        @endphp
        <a href="{{ $mentorBackUrl }}" class="btn btn-sm flex-shrink-0 btn-kembali-gold text-decoration-none">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body text-center py-4">
                    ...
                    @else
                        @php
                            $canInputNilai = $data->status != 9;
                            $canSaveNilai = $canInputNilai && $data->file_nilai;
                        @endphp
                        <div class="px-2">
                            <input type="number" name="nilai" id="nilai" class="form-control form-control-lg text-center mb-3 border-gold-solid" placeholder="0-100" @if(!$canSaveNilai) disabled @endif>
                            <button type="button" class="btn btn-gold-gradient w-100 btn-simpan-nilai py-2" data-can="{{ $canSaveNilai ? 1 : 0 }}">Simpan Skor</button>
                            @if(!$data->file_nilai)
                                <div class="text-danger small mt-3 fw-bold"><i class="ri-error-warning-line"></i> File nilai belum diunggah</div>
                            @endif
                        </div>
                    @endif
                </div>
