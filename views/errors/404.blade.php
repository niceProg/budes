...
<body>
    ...
    <div class="error-wrapper">
        <div class="error-content animate-up">
            ...
            <h2 class="error-title">Halaman ini tidak ditemukan</h2>

            <p class="error-message">
                Maaf, halaman yang Anda cari tidak ditemukan. Silakan klik <a href="{{ $returnUrl }}" style="color: var(--primary-color); font-weight: 800; text-decoration:none;">Kembali</a>.
            </p>
        </div>
    </div>
</body>
