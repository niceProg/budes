...
<head>
    ...
    <title>401 - Tidak Terotorisasi | {{ config('app.name') }}</title>
...
<body>
    ...
    @php
        // 401: biasanya butuh login. Jika sudah login, arahkan ke dashboard sesuai role.
    ...
    <div class="error-wrapper">
        <div class="error-content animate-up">
            ...
            <p class="error-message">
                Anda harus masuk terlebih dahulu untuk mengakses halaman ini. Silakan klik <a href="{{ $returnUrl }}" style="color: var(--primary-color); font-weight: 800; text-decoration:none;">Kembali</a>.
            </p>
        </div>
    </div>
</body>
