...
@section('title', 'Detail Roles Internal | Admin - SMART Setjen DPR RI')
@section('content')
<style>
    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                <li class="breadcrumb-item"><a href="{{ route('roles-internal.index') }}">Roles Internal</a></li>
                <li class="breadcrumb-item active fw-bold" style="color: var(--gold-solid)" aria-current="page">Detail Informasi</li>
            </ol>
        </nav>
        <h1 class="page-title">Profil Data Role Internal</h1>
    </div>
    ...
    <div class="modern-card">
        <div class="detail-container">
            ...
            <div class="info-box">
                ...
                <div class="info-content">
                    <div class="info-label">Nama Role Internal</div>
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('roles-internal.index') }}" class="btn-back">
