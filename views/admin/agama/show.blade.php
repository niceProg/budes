...
@section('title', 'Detail Agama | Admin - SMART Setjen DPR RI')
@section('content')
<style>
...
<div class="content-wrapper">
    <div class="page-header">
        ...
        <h1 class="page-title">Profil Data Agama</h1>
    </div>
    ...
    <div class="modern-card">
        <div class="detail-container">
            ...
            <div class="info-box">
                ...
                <div class="info-content">
                    <div class="info-label">Nama Agama</div>
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('agama.index') }}" class="btn-back">
