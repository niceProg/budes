...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <ol class="breadcrumb fs-sm mb-1">
                ...
                <li class="breadcrumb-item"><a href="{{ route('parja.kegiatan.index') }}">Daftar Kegiatan</a></li>
            </ol>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <form action="{{ route('parja.kegiatan.update', $kegiatan->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <input required type="text" class="form-control w-50" id="kegiatan" name="kegiatan"
                                placeholder="Masukan Kegiatan" value="{{ $kegiatan->kegiatan }}">
