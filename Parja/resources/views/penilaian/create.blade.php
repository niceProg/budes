...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Tambah Penilaian</h4>
        </div>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('parja.penilaian.store') }}" method="POST">
                @csrf
                @method('POST')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" min="0" max="100" class="form-control w-25"
                        id="nilai_total" name="nilai_total" placeholder="0.00" value="{{ old('nilai_total') }}">
