...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        <ol class="breadcrumb fs-sm mb-1">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daftar Penilaian Esai (Belum)</li>
        </ol>
        <h4 class="main-title mb-0">Daftar Peserta Belum Dinilai Esai</h4>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if (rbac_can_create_parja())
                                    <a href="{{ route('parja.penilaian_esai.add', $peserta->id) }}" class="btn btn-success btn-sm">
                                        <i class="ri-add-line"></i> Nilai Esai
                                    </a>
                                @endif
                            </td>
                        </tr>
