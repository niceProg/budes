...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Edit Partisipasi</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <form action="{{ route('parja.partisipasi.update', $partisipasi->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <input required type="text" class="form-control w-50" id="partisipasi" name="partisipasi"
                                placeholder="Masukan Partisipasi" value="{{ $partisipasi->partisipasi }}">
