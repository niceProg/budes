...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="main-title mb-0">Detail Peserta</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 fs-sm">
                <li class="breadcrumb-item"><a href="{{ route('parja.survei.peserta.index', $survei->id) }}">Peserta</a></li>
                <li class="breadcrumb-item active">Detail</li>
            </ol>
        </nav>
    </div>
    <a href="{{ route('parja.survei.peserta.index', $survei->id) }}" class="btn btn-secondary btn-sm">
...
<div class="card card-one" style="max-width:560px">
    ...
    <div class="card-body">
        <table class="table table-sm table-borderless">
            ...
            <tr><th class="text-muted">Nama Responden</th><td>{{ $peserta->responden->nama ?? '-' }}</td></tr>
            <tr><th class="text-muted">No. Telepon</th><td>{{ $peserta->responden->nomor_telepon ?? '-' }}</td></tr>
            ...
            <tr><th class="text-muted">Progress</th><td>{{ number_format($peserta->persentase_selesai, 0) }}%</td></tr>
