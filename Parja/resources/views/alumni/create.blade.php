...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <ol class="breadcrumb fs-sm mb-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">Register Akun Alumni</li>
            </ol>
            <h4 class="main-title mb-0">Register Akun Alumni</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('parja.alumni.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" placeholder="Masukkan email alumni" value="{{ old('email') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->first('password') ?: 'Password wajib diisi, minimal 8 karakter.' }}</div>
                        </div>

                        <div class="mb-3">
                            <label for="nama" class="form-label fw-bold">Nama <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" placeholder="Masukkan nama alumni" value="{{ old('nama') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('id_dapil') is-invalid @enderror" id="id_dapil"
                                ...
                                @forelse($dapils as $dapil)
                                    <option value="{{ $dapil->id }}" {{ old('id_dapil') == $dapil->id ? 'selected' : '' }}>
                                        {{ $dapil->dapil }}
                                    </option>
                                @empty
                        ...
                        <div class="mb-3" id="no_anggota_wrap">
                            ...
                            <input type="text" class="form-control @error('no_anggota') is-invalid @enderror"
                                ...
                                value="{{ old('no_anggota') }}" maxlength="50">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('approval_status') is-invalid @enderror" id="approval_status"
                                ...
                                <option value="0" {{ old('approval_status') == 0 ? 'selected' : '' }}>⏳ Pending — Menunggu
                                    Verifikasi</option>
                                <option value="1" {{ old('approval_status') == 1 ? 'selected' : '' }}>✅ Disetujui — Akun Aktif
                                </option>
                                <option value="2" {{ old('approval_status') == 2 ? 'selected' : '' }}>✗ Ditolak — Akun
                                    Nonaktif</option>
                            </select>
                            <div class="form-text">Tentukan apakah akun alumni ini dapat mengakses portal Parja Alumni.
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3" id="catatan-tolak-wrapper"
                            style="{{ old('approval_status') == 2 ? '' : 'display:none;' }}">
                            ...
                            <textarea class="form-control @error('catatan_tolak') is-invalid @enderror" id="catatan_tolak"
                                ...
                                placeholder="Tuliskan alasan penolakan yang akan ditampilkan kepada alumni...">{{ old('catatan_tolak') }}</textarea>
