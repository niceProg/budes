...
<div class="d-sm-flex align-items-center justify-content-between mb-4 ">
    ...
    <div>
        @if (rbac_can_create_parja())
            <a href="{{ route('parja.kriteria.add') }}" class="btn btn-success">
                <i class="ri-pencil-line"></i> Tambah Kriteria
            </a>
        @endif
    </div>
</div>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="p-1 text-center" style="width: 50%;">Kriteria</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if (rbac_can_edit_parja())
                                    <a href="{{ route('parja.kriteria.edit', $kriteria->id) }}" class="btn btn-primary
">
                                ...
                                @if (rbac_can_delete_parja())
                                    <form action="{{ route('parja.kriteria.destroy', $kriteria->id) }}" method="POST"
